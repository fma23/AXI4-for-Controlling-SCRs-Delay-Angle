...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set LED_1 [ create_bd_port -dir O -from 7 -to 0 LED_1 ]
  set SquareWave1 [ create_bd_port -dir I SquareWave1 ]
  set SquareWave2 [ create_bd_port -dir I SquareWave2 ]
  set SquareWave3 [ create_bd_port -dir I SquareWave3 ]
  set Thyristors_1 [ create_bd_port -dir O -from 5 -to 0 Thyristors_1 ]
  set clock [ create_bd_port -dir I -type clk clock ]
  set reset [ create_bd_port -dir I -type rst reset ]

  # Create instance: SCRs_Controller_0, and set properties
  set SCRs_Controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:SCRs_Controller:1.0 SCRs_Controller_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins SCRs_Controller_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net SCRs_Controller_0_LED [get_bd_ports LED_1] [get_bd_pins SCRs_Controller_0/LED]
  connect_bd_net -net SCRs_Controller_0_Thyristors [get_bd_ports Thyristors_1] [get_bd_pins SCRs_Controller_0/Thyristors]
  connect_bd_net -net SquareWave1_1 [get_bd_ports SquareWave1] [get_bd_pins SCRs_Controller_0/SquareWave1]
  connect_bd_net -net SquareWave2_1 [get_bd_ports SquareWave2] [get_bd_pins SCRs_Controller_0/SquareWave2]
  connect_bd_net -net SquareWave3_1 [get_bd_ports SquareWave3] [get_bd_pins SCRs_Controller_0/SquareWave3]
  connect_bd_net -net clock_1 [get_bd_ports clock] [get_bd_pins SCRs_Controller_0/clock]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins SCRs_Controller_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins SCRs_Controller_0/reset]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins SCRs_Controller_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SCRs_Controller_0/S00_AXI/S00_AXI_reg] SEG_SCRs_Controller_0_S00_AXI_reg
...
preplace port clock -pg 1 -y 300 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace port reset -pg 1 -y 320 -defaultsOSRD
preplace portBus LED_1 -pg 1 -y 230 -defaultsOSRD
preplace portBus Thyristors_1 -pg 1 -y 210 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 180 -defaultsOSRD
preplace inst SCRs_Controller_0 -pg 1 -lvl 3 -y 220 -defaultsOSRD
...
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 440 460 720
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 20 270 400
preplace netloc SCRs_Controller_0_LED 1 3 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 60 NJ 60 NJ
preplace netloc clock_1 1 0 3 NJ 300 410J 20 720J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 10 260 430 300 710
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 700
preplace netloc reset_1 1 0 3 NJ 320 NJ 320 700J
preplace netloc SCRs_Controller_0_Thyristors 1 3 1 NJ
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 420
levelinfo -pg 1 -10 210 570 860 1000 -top 0 -bot 520
",
}
